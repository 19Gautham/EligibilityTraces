...
def readCommand(argv):
    ...
    # print("Agent options: {}".format(agentOpts))
    ...
    for moduleDir in pythonPathDirs:
        ...
        for modulename in moduleNames:
            try:
                ...
                print("Yes, there is an issue with the import. Module: {}".format(modulename[:-3]))
                print("Execptions: {}".format(e))
                continue
...
def runGames(layout, pacman, ghosts, display, numGames, record, numTraining=0, catchExceptions=False, timeout=30):
    ...
    if (numGames-numTraining) > 0:
        ...
        with open("score_0.txt", "a") as score_file:
...
if __name__ == '__main__':
    ...
    # print("Args collected so far: {}".format(args))
    runGames(**args)
